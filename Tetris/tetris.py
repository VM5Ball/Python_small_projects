...
class Tetris():
    ...
    #this func check both if it is the limit of the window and there is another tetromino
    ...
    def move(self, dr, dc):
        with self.move_lock:
            ...
            if all(self.is_cell_free(r + dr, c + dc) for (r, c) in self.get_tetromino_coords()):                #if the cell is free, the move
